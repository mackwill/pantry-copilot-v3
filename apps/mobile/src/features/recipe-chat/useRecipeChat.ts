...
/**
 * Mobile recipe co-pilot hook — the web analogue, reducing `recipes.tweakStream`
 * through the same shared `@pantry/utils` reducer so the logic is unit-tested once.
 */
