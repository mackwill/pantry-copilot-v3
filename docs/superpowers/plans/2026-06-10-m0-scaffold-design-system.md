...
- [ ] **Step 2: Install eslint deps at workspace root**
...
- [ ] **Step 3: Write the base ESLint flat config**
...
- [ ] **Step 4: TDD the env loader — failing test first**
...
- [ ] **Step 1: Package scaffold** (same pattern as Task 2; add `"generate:tokens": "tsx scripts/generate-native-tokens.ts"` script; deps: `react react-dom`, dev: `tsx @types/react @testing-library/react @testing-library/jest-dom jsdom`)

- [ ] **Step 2: Port tokens.css verbatim + copy fonts**
...
- [ ] **Step 3: TDD the native-token generator — failing test**
...
- [ ] **Step 5: Verify** `pnpm --filter @pantry/design-system test && pnpm lint` — PASS.

- [ ] **Step 6: Commit** `git commit -m "feat(design-system): Kitchen OS tokens + generated native mirror"`
