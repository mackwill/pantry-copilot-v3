...
| M4 — Home + generation + result                  | web complete · mobile (Slice G) pending | `docs/superpowers/plans/2026-06-14-m4-home-generation-result.md` — contracts/AI/DB/API/SSE-spike + **web** Home/Thinking/Drafting/Result done; 4 web frames approved + web e2e green (`docs/checklists/m4-generation.md`). Slice G (mobile UI) + mobile fidelity/e2e remain |
